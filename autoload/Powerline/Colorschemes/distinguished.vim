let g:Powerline#Colorschemes#distinguished#colorscheme = Pl#Colorscheme#Init([
	...
	\                           'scrollpercent',
	\                           'raw'],                                 Pl#Hi#Create(Pl#Hi#Cterm(250, 240)        ), { 'N': Pl#Hi#Create(Pl#Hi#Cterm(239, 235)        ), 'i': Pl#Hi#Create(Pl#Hi#Cterm(117,  31)        ), } ),
	...
	\                           'fileformat',
	\                           'fileencoding'],                        Pl#Hi#Create(Pl#Hi#Cterm(247, 236)        ), {                                                   'i': Pl#Hi#Create(Pl#Hi#Cterm(117,  24)        ), } ),
